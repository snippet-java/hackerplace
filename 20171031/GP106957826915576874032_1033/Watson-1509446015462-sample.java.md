## NLU - Analyze Emotions

This code shows you how to use the Java API to analyze emotion from given text.
...
3. The results show the anger, disgust, fear, joy, and sadness implied in text.
