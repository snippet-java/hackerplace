## NLU - Identify Categories

This code shows you how to use the Java API to identify categories of provided link of article.
...
3. The results show the categories identified from article.
