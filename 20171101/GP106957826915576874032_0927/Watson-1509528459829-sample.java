...
public class Categories {
  ...
  private static String testparams =
    "{\"nlu_source\" : \"http://www.espn.com/tennis/story/_/id/18436908/australian-open-2017-tournament-news-schedule-live-scores-tv-coverage\","  +
    " \"username\"       : \"\"," +
    " \"password\"       : \"\"," +
  ...
  public static void main(String[] args) {
    System.out.println(main(new JsonParser().parse(Categories.testparams).getAsJsonObject()).getAsJsonPrimitive("result").getAsString());
  }
