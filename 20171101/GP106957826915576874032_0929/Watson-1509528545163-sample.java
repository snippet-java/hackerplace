...
public class Entities {
  ...
  private static String testparams =
    "{\"nlu_source\" : \"http://www.techradar.com/news/phone-and-communications/mobile-phones/20-best-mobile-phones-in-the-world-today-645440\","  +
    " \"username\"       : \"\"," +
    " \"password\"       : \"\"," +
  ...
  public static void main(String[] args) {
    System.out.println(main(new JsonParser().parse(Entities.testparams).getAsJsonObject()).getAsJsonPrimitive("result").getAsString());
  }
