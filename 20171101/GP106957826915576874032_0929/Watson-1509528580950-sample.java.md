## NLU - Extract Keywords

This code shows you how to use the Java API to extract keywords from article of given url.
...
3. The results show the keywords extracted from article.
